...
function show_WorkCom_dialog(report) {
    let d = new frappe.ui.Dialog({
        ...
        primary_action: function (values) {
            ...
            frappe.call({
                method: "construction_v1.construction_v1.report.beneficiary_status_analysis.beneficiary_status_analysis.get_ai_insights",
                args: {
...
function show_gender_chart() {
    frappe.call({
        method: "construction_v1.construction_v1.report.beneficiary_status_analysis.beneficiary_status_analysis.get_gender_chart",
        callback: function (r) {
            if (r && r.message) {
...
function show_status_chart() {
    frappe.call({
        method: "construction_v1.construction_v1.report.beneficiary_status_analysis.beneficiary_status_analysis.get_status_chart",
        callback: function (r) {
            if (r && r.message) {
...
function show_trend_chart() {
    frappe.call({
        method: "construction_v1.construction_v1.report.beneficiary_status_analysis.beneficiary_status_analysis.get_trend_chart",
        args: { months: 6 },
        callback: function (r) {
            if (r && r.message) {
